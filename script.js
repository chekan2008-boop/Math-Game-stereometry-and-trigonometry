...
const questions = {
    ...
    stereometry: {
        easy: [
            ...
            {
                question: "Найдите объем шара радиусом 2 см (π≈3.14)",
                answers: ["33.49 см³", "25.12 см³", "50.24 см³", "12.56 см³"],
                correct: "33.49 см³",
                formula: "V = 4/3πR³ = 4/3 × 3.14 × 8 ≈ 33.49 см³",
                hint: "R³ = 2³ = 8",
                explanation: "4/3 × 3.14 × 8 = 33.49 см³ (округленно)."
            },
            {
                question: "Найдите объем шара радиусом 5 см (π≈3.14)",
                answers: ["523.33 см³", "314 см³", "157 см³", "78.5 см³"],
                correct: "523.33 см³",
                formula: "V = 4/3πR³ = 4/3 × 3.14 × 125 ≈ 523.33 см³",
                hint: "R³ = 5³ = 125",
                explanation: "4/3 × 3.14 × 125 = 523.33 см³ (округленно)."
            },
            {
                question: "Найдите объем цилиндра радиусом 3 см и высотой 4 см (π≈3.14)",
                answers: ["113.04 см³", "75.36 см³", "150.72 см³", "37.68 см³"],
                correct: "113.04 см³",
                formula: "V = πR²h = 3.14 × 9 × 4 = 113.04 см³",
                hint: "R² = 3² = 9",
                explanation: "Площадь основания: 3.14 × 9 = 28.26 см², объем: 28.26 × 4 = 113.04 см³."
            },
            {
                question: "Найдите объем цилиндра радиусом 2.5 см и высотой 6 см (π≈3.14)",
                answers: ["117.75 см³", "94.2 см³", "235.5 см³", "47.1 см³"],
                correct: "117.75 см³",
                formula: "V = πR²h = 3.14 × 6.25 × 6 = 117.75 см³",
                hint: "R² = 2.5² = 6.25",
                explanation: "3.14 × 6.25 = 19.625, 19.625 × 6 = 117.75 см³."
            },
            {
                question: "Найдите объем конуса радиусом 3 см и высотой 4 см (π≈3.14)",
                answers: ["37.68 см³", "113.04 см³", "75.36 см³", "18.84 см³"],
                correct: "37.68 см³",
                formula: "V = 1/3πR²h = 1/3 × 3.14 × 9 × 4 = 37.68 см³",
                hint: "Объем конуса в 3 раза меньше объема цилиндра",
                explanation: "1/3 от объема цилиндра с такими же основанием и высотой."
            },
            {
                question: "Найдите объем конуса радиусом 6 см и высотой 5 см (π≈3.14)",
                answers: ["188.4 см³", "94.2 см³", "565.2 см³", "282.6 см³"],
                correct: "188.4 см³",
                formula: "V = 1/3πR²h = 1/3 × 3.14 × 36 × 5 = 188.4 см³",
                hint: "R² = 6² = 36",
                explanation: "1/3 × 3.14 × 36 × 5 = 188.4 см³."
            },
            {
            ...
            {
                question: "Найдите площадь поверхности сферы радиусом 3 см (π≈3.14)",
                answers: ["113.04 см²", "84.78 см²", "56.52 см²", "28.26 см²"],
                correct: "113.04 см²",
                formula: "S = 4πR² = 4 × 3.14 × 9 = 113.04 см²",
                hint: "R² = 3² = 9",
                explanation: "4 × 3.14 × 9 = 113.04 см²."
            },
            {
                question: "Найдите площадь поверхности сферы радиусом 7 см (π≈3.14)",
                answers: ["615.44 см²", "307.72 см²", "153.86 см²", "76.93 см²"],
                correct: "615.44 см²",
                formula: "S = 4πR² = 4 × 3.14 × 49 = 615.44 см²",
                hint: "R² = 7² = 49",
                explanation: "4 × 3.14 × 49 = 615.44 см²."
            },
            {
                question: "Найдите площадь боковой поверхности цилиндра радиусом 4 см и высотой 5 см (π≈3.14)",
                answers: ["125.6 см²", "62.8 см²", "251.2 см²", "50.24 см²"],
                correct: "125.6 см²",
                formula: "S_бок = 2πRh = 2 × 3.14 × 4 × 5 = 125.6 см²",
                hint: "Боковая поверхность цилиндра - прямоугольник",
                explanation: "Длина окружности: 2 × 3.14 × 4 = 25.12 см, площадь: 25.12 × 5 = 125.6 см²."
            },
            {
                question: "Найдите площадь полной поверхности цилиндра радиусом 2 см и высотой 3 см (π≈3.14)",
                answers: ["62.8 см²", "37.68 см²", "75.36 см²", "25.12 см²"],
                correct: "62.8 см²",
                formula: "S = 2πR(h+R) = 2 × 3.14 × 2 × (3+2) = 62.8 см²",
                hint: "S = 2πR(h+R) = S_бок + 2S_осн",
                explanation: "2 × 3.14 × 2 × 5 = 62.8 см²."
            },
            {
                question: "Найдите площадь боковой поверхности конуса радиусом 3 см и образующей 5 см (π≈3.14)",
                answers: ["47.1 см²", "94.2 см²", "23.55 см²", "141.3 см²"],
                correct: "47.1 см²",
                formula: "S_бок = πRl = 3.14 × 3 × 5 = 47.1 см²",
                hint: "Боковая поверхность конуса: S = πRl",
                explanation: "3.14 × 3 × 5 = 47.1 см²."
            },
            {
                question: "Найдите площадь полной поверхности конуса радиусом 4 см и образующей 6 см (π≈3.14)",
                answers: ["125.6 см²", "75.36 см²", "100.48 см²", "50.24 см²"],
                correct: "125.6 см²",
                formula: "S = πR(l+R) = 3.14 × 4 × (6+4) = 125.6 см²",
                hint: "S = πR(l+R) = S_бок + S_осн",
                explanation: "3.14 × 4 × 10 = 125.6 см²."
            },
            {
        ...
        medium: [
            ...
            {
                question: "В куб вписан шар. Найдите отношение объема куба к объему шара (π≈3.14)",
                answers: ["1.91", "2.00", "3.14", "1.50"],
                correct: "1.91",
                formula: "V_куб/V_шар = a³ / (4/3π(a/2)³) = 6/π ≈ 1.91",
                hint: "Диаметр шара равен ребру куба",
                explanation: "Если ребро куба = a, то радиус шара = a/2. V_куб/V_шар = a³ / (4/3π(a/2)³) = 6/π ≈ 1.91."
            },
            {
                question: "В шар вписан куб. Диагональ куба равна диаметру шара. Найдите отношение объемов шара и куба (π≈3.14)",
                answers: ["2.72", "3.14", "1.91", "2.00"],
                correct: "2.72",
                formula: "d_куб = a√3 = D_шар ⇒ V_шар/V_куб = (π√3)/2 ≈ 2.72",
                hint: "Диагональ куба: d = a√3",
                explanation: "a√3 = 2R ⇒ a = 2R/√3. V_шар/V_куб = (4/3πR³) / (a³) = (4/3πR³) / (8R³/3√3) = (π√3)/2 ≈ 2.72."
            },
            {
            ...
            {
                question: "Радиусы оснований усеченного конуса равны 3 см и 6 см, высота 4 см. Найдите объем (π≈3.14)",
                answers: ["263.76 см³", "131.88 см³", "87.92 см³", "175.84 см³"],
                correct: "263.76 см³",
                formula: "V = 1/3πh(R²+Rr+r²) = 1/3×3.14×4×(36+18+9) = 263.76 см³",
                hint: "Формула объема усеченного конуса",
                explanation: "1/3×3.14×4×(36+18+9) = 1/3×3.14×4×63 = 263.76 см³."
            }
        ],
        hard: [
...
// Функции для генерации дополнительных вопросов
function generateAdditionalTrigonometryQuestions(count) {
    const additional = [];
    ...
    for (let i = 0; i < count; i++) {
        ...
        if (func === 'sin') {
            correct = Math.sin(angle * Math.PI / 180).toFixed(2);
            formula = `${func}(${angle}°) = ${correct}`;
        } else if (func === 'cos') {
            correct = Math.cos(angle * Math.PI / 180).toFixed(2);
            formula = `${func}(${angle}°) = ${correct}`;
        } else {
            if (angle % 90 === 0 && angle % 180 !== 0) {
                correct = 'не существует';
                formula = `${func}(${angle}°) не существует`;
            } else {
                correct = Math.tan(angle * Math.PI / 180).toFixed(2);
                formula = `${func}(${angle}°) = ${correct}`;
            }
        }
        ...
        while (answers.length < 4) {
            const wrong = (parseFloat(correct) + (Math.random() - 0.5) * 2).toFixed(2);
        ...
        additional.push({
            question: `Чему равен ${func}(${angle}°)?`,
            answers: answers,
            correct: correct,
            formula: formula,
            hint: `Используйте тригонометрические значения для ${angle}°`,
            explanation: `Это значение ${func}(${angle}°) можно найти в таблице тригонометрических значений.`
        });
    }
...
// Добавляем сгенерированные вопросы в базу для режима на 20 вопросов
function enrichQuestionsFor20Mode() {
    // Добавляем 50 дополнительных вопросов по тригонометрии в каждый уровень
    questions.trigonometry.easy.push(...generateAdditionalTrigonometryQuestions(30));
    questions.trigonometry.medium.push(...generateAdditionalTrigonometryQuestions(30));
    questions.trigonometry.hard.push(...generateAdditionalTrigonometryQuestions(40));
    
    // Добавляем 50 дополнительных вопросов по стереометрии в каждый уровень
